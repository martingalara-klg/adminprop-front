...
| `sdd_02_domain_model` | Modelo de dominio + invariantes (RN-C/P/L/A/D) | core | Activo | 1.8 | ✅ | ✅ (lectura) |
| `sdd_03_api_contracts` | Contratos REST de la API | core | Activo | 1.15 | ✅ | ✅ **compartido — vinculante** |
...
| `spec_module_03_contratos` | Módulo 3 — Contratos + ajustes por índice | features | Activo | 1.5 | ✅ | ✅ |
...
| `spec_data_model` | Modelo de datos físico (23 tablas, RLS, migraciones) | infrastructure | Activo | 1.4 | ✅ | ⚪ |
